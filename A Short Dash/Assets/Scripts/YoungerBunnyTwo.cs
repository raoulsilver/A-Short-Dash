...
public class YoungerBunnyTwo : TextWindowLoader
{
    ...
    void Start()
    {
        ...
        {
            shovelWorldModel.SetActive(true);
        }
        if (PlayerPrefs.GetInt("yBunny2QuestFinished")==1)
        {
            flowerCrownModel.SetActive(true);
        }
        else
        {
            flowerCrownModel.SetActive(false);
        }
